<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Especiales</h1>
<!-- DataTales Begin Platos Combinados -->
<div class="card shadow mb-4">
    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
        <h6 class="m-0 font-weight-bold text-primary">Platos Combinados</h6>
        <a href="" onclick="show_modal_product_insert(6,1,'Platos Combinados');" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal">
...
<!-- DataTales End Platos Combinados -->
 <!-- DataTales Begin Hamburguesas -->
<div class="card shadow mb-4">
    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
        <h6 class="m-0 font-weight-bold text-primary">Hamburguesas</h6>
        <a href="" onclick="show_modal_product_insert(6,2,'Hamburguesas');" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal">
            <i class="fas fa-plus-square fa-sm text-white-50"></i> Nuevo Item
        </a>
    </div>
    <div class="card-body">
...
<!-- DataTales End Hamburguesas -->
<!-- DataTales Begin Pizzas -->
<div class="card shadow mb-4">
    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
        <h6 class="m-0 font-weight-bold text-primary">Pizzas</h6>
        <a href="" onclick="show_modal_product_insert(6,3,'Pizzas');" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal">
            <i class="fas fa-plus-square fa-sm text-white-50"></i> Nuevo Item
        </a>
    </div>
    <div class="card-body">
