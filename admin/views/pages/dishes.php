...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse show" aria-labelledby="headingThree"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="?accion=dishes">Platos</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="container-main" class="container-fluid">
                    <!-- Header -->
                    <?php include('fragments/dishes-detail.php'); ?>
                    <!-- End of header -->
                </div>
                <!-- /.container-fluid -->
            </div>
    ...
    <input type="hidden" class="form-control form-control-user" id="page" name="page" value="dishes">
    <!-- Logout Modal-->
