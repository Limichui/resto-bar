...
<html lang="en">
<head>
    <meta charset="utf-8"><title>Robert's - Administración</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="container-main" class="container-fluid">
                    <!-- Header -->
                    <?php include('fragments/cocktails-detail.php'); ?>
                    <!-- End of header -->
                </div>
                <!-- /.container-fluid -->
            </div>
    ...
    <input type="hidden" class="form-control form-control-user" id="page" name="page" value="cocktails">
    <!-- Logout Modal-->
