...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="">Menú Diario</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="container-main" class="container-fluid">
                    <!-- Header -->
                    <?php include('fragments/daily-menu-detail.php'); ?>
                    <!-- End of header -->
                </div>
                <!-- /.container-fluid -->
            </div>
    ...
    <input type="hidden" class="form-control form-control-user" id="page" name="page" value="daily-menu">
    <!-- Logout Modal-->
